...
<body>
    ...
    <div id="appCapsule">
        ...
        <div class="header-large-title-logbook">
            <h1 class="title">JADWAL SIDANG</h1>
        </div>
        <div class="section mt-3 mb-3">
            <div class="card">
                <div class="card-body">
                    <form action="/proses_logbook" method="POST">
                        <label for="nama">Jenis Usulan :</label><br>
                        <input type="jenis" id="jenis" name="jenis" placeholder="Usulan Tugas Akhir" required><br>
                        
                        <label for="output">Nama & Judul :</label><br>
                        <input type="nama" id="output" name="output" placeholder="Nama & Judul Tugas Akhir" required><br>

                        <label for="output">Penguji 1 :</label><br>
                        <input type="output" id="output" name="output" placeholder="Nama Dosen Penguji 1" required><br>

                        <label for="output">Penguji 2 :</label><br>
                        <input type="output" id="output" name="output" placeholder="Nama Dosen Penguji 2" required><br>

                        <label for="tanggalmulai">Tanggal Sidang :</label><br>
                        <input type="date" id="tanggalmulai" name="tanggalmulai" required><br>

                        <label for="output">Jam Sidang :</label><br>
                        <input type="output" id="output" name="output" placeholder="Jam Sidang Tugas Akhir" required><br>
                    </form>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content">
                <div class="modal-body p-0">
                    ...
                    <div class="profileBox">
                        ...
                        <div class="in">
                            <strong>Respati Hadinata</strong>
