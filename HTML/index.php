...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/png" href="assets/img/polibatam.png">
                                    ...
                                    <nav>
                                        ...
                                        <div class="header-menu dosis">
                                            <ul>
                                                ...
                                                <li><a href="#pricing  ">Tampilan</a></li>
                ...
                <div class="row align-items-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="banner-text-inner">
                            ...
                            <p>Sistem Informasi Tugas Akhir, merupakan aplikasi mobile yang dirancang untuk mempermudah proses pengerjaan tugas akhir mahasiswa informatika. Sistem ini menyediakan akses mudah ke informasi penting dan melancarkan komunikasi antara mahasiswa dengan dosen pembimbing.</p>
                        </div>
                        <!-- banner text -->
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-8">
                    ...
                    <div class="section-title text-center">
                        <h2>FITUR</h2>
                        <p>Dalam Sebuah pengembangan sistem  membutuhkan fitur-fitur tertentu. adapaun fitur dalam aplikasi ini yaitu</p>
                    </div>
                ...
                <div class="col-xl-10 col-lg-12">
                    <div class="feature-carousel owl-carousel">
                        ...
                        <div class="single-feature-inner text-center">
                            <div class="feature-icon"><img src="assets/img/sample/photo/daftar_dosen.png" class="svg" alt=""></div>
                            <h5>Daftar Dosen</h5>
                            <p>Aplikasi SITA merancang untuk User bisa melihat
                                kontak dosen dan mempermudah komunikasi.</p>
                        </div>
                        <!-- End of single feature inner -->

                        <!-- single feature inner -->
                        <div class="single-feature-inner text-center">
                            <div class="feature-icon"><img src="assets/img/sample/photo/tugas_akhir.png" class="svg" alt=""></div>
                            <h5>Tugas Akhir</h5>
                            <p>Aplikasi SITA merancang agar mempermudah User
                                dan Admin dalam mengelola Tugas Akhir.</p>
                        </div>
                        <!-- End of single feature inner -->

                        <!-- single feature inner -->
                        <div class="single-feature-inner text-center">
                            <div class="feature-icon"><img src="assets/img/sample/photo/daftar_sidang.png" class="svg" alt=""></div>
                            <h5>Jadwal Sidang</h5>
                            <p>Aplikasi SITA merancang agar mempermudah User
                                dan Admin dalam melihat Daftar Sidang.</p>
                        </div>
                        <!-- End of single feature inner -->

                        <!-- single feature inner -->
                        <div class="single-feature-inner text-center">
                            <div class="feature-icon"><img src="assets/img/sample/photo/logbook.png" class="svg" alt=""></div>
                            <h5>Logbook</h5>
                            <p>Aplikasi SITA merancang agar mempermudah User
                                dan Admin dalam melihat catatan Logbook..</p>
                ...
                <div class="col-lg-5 col-sm-5">
                    ...
                    <div class="user-interact-inner">
                        ...
                        <p>
                            ...
                            Jurusan Teknik Informatika sudah ada dalam bentuk Website dan
                            bisa di akses.
                        </p>
                        <a href="https://if.polibatam.ac.id/tugas-akhir/" class="btn">Get Started</a>
                    </div>
                    <!--End of user ineract text -->
                </div>
                <div class="col-lg-5 col-sm-5 offset-lg-2 offset-sm-2">
                    <!-- user interact image -->
            ...
            <div class="app-carousel-inner">
                <div class="app-carousel owl-carousel">
                    ...
                    <div class="single-app-image">
                        <img src="assets/img/login.jpg" data-rjs="2" alt="">
                    </div>
                    <!-- slingle app image -->

                    <!-- slingle app image -->
                    <div class="single-app-image">
                        <img src="assets/img/home.jpg" data-rjs="2" alt="">
                    </div>
                    <!-- slingle app image -->

                    <!-- slingle app image -->
                    <div class="single-app-image">
                        <img src="assets/img/sidebar.jpg" data-rjs="2" alt="">
                    </div>
                    <!-- slingle app image -->

                    <!-- slingle app image -->
                    <div class="single-app-image">
                        <img src="assets/img/tugas akhir1.jpg" data-rjs="2" alt="">
                    </div>
                    <!-- slingle app image -->

                    <!-- slingle app image -->
                    <div class="single-app-image">
                        <img src="assets/img/jadwal sidang.jpg" data-rjs="2" alt="">
                    </div>
                    <!-- slingle app image -->

                    <!-- slingle app image -->
                    <div class="single-app-image">
                        <img src="assets/img/daftar dosen.jpg" data-rjs="2" alt="">
                    </div>
                    <!-- slingle app image -->

                    <!-- slingle app image -->
                    <div class="single-app-image">
                        <img src="assets/img/logbook.jpg" data-rjs="2" alt="">
                    </div>
                    <!-- slingle app image -->
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-8">
                    ...
                    <div class="section-title text-center">
                        <h2>PBL TIM</h2>
                        <p>Tim Project Based Learning Sistem Informasi Tugas Akhir Berbasis Mobile</p>
                    </div>
                    <!-- End of section title -->
                </div>
            </div>
                        ...
                        <div class="post-content">
                            <div class="post-details">
                                <div class="post-title">
                                    <h3><a>Respati Hadinata</a></h3>
                                </div>
                                <p>Mahasiswa Program Studi Teknik Informatika Politeknik Negeri Batam</p>
                            </div>
                ...
                <div class="col-lg-4 col-md-4">
                    ...
                    <div class="single-blog-inner">
                        ...
                        <div class="post-content">
                            <div class="post-details">
                                <div class="post-title">
                                    <h3><a>Gita Faudia Abddul</a></h3>
                                </div>
                                <p>Mahasiswa PMM4 dari Politeknik Negeri Ketapang Kalimantan Barat</p>
                            </div>
                        </div><!-- /.End of post content -->
                    </div><!-- /.End of single blog inner -->
                </div>
    ...
    <footer class="footer">
        <div class="footer-bottom">
            <div class="footer-text text-center">
                <p>© copyright 2024 by Teknik Informatika POLIBATAM</p>       
            </div>
        </div>
